...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference("Gift.count") do
      post gifts_url, params: { gift: { friend_id: @gift.friend_id, name: @gift.name, price: @gift.price, url: @gift.url } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { friend_id: @gift.friend_id, name: @gift.name, price: @gift.price, url: @gift.url } }
